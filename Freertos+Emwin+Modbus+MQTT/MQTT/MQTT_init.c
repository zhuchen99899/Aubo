...
SETSUBSCRIBE[subscribe_count-1].string=subscrible1_topicFilters1;
	
SETSUBSCRIBE[subscribe_count-1].len=strlen(subscrible1_topicFilters1);
	
QoSs[subscribe_count-1]=subscribe1_qos1;    
